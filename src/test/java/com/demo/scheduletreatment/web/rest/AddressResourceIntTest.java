...
import com.demo.scheduletreatment.repository.AddressRepository;
import com.demo.scheduletreatment.repository.search.AddressSearchRepository;
...
public class AddressResourceIntTest {
    ...
    private static final String DEFAULT_DESCRIPTION_ADDRESS = "AAAAAAAAAA";
    private static final String UPDATED_DESCRIPTION_ADDRESS = "BBBBBBBBBB";
     ...
     *
     * @see com.demo.scheduletreatment.repository.search.AddressSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address()
            .descriptionAddress(DEFAULT_DESCRIPTION_ADDRESS)
    ...
    public void createAddress() throws Exception {
        ...
        assertThat(testAddress.getDescriptionAddress()).isEqualTo(DEFAULT_DESCRIPTION_ADDRESS);
        assertThat(testAddress.getReferences()).isEqualTo(DEFAULT_REFERENCES);
    ...
    public void getAllAddresses() throws Exception {
        ...
        restAddressMockMvc.perform(get("/api/addresses?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].descriptionAddress").value(hasItem(DEFAULT_DESCRIPTION_ADDRESS.toString())))
    ...
    public void getAddress() throws Exception {
        ...
        restAddressMockMvc.perform(get("/api/addresses/{id}", address.getId()))
            ...
            .andExpect(jsonPath("$.descriptionAddress").value(DEFAULT_DESCRIPTION_ADDRESS.toString()))
    ...
    public void updateAddress() throws Exception {
        ...
        updatedAddress
            .descriptionAddress(UPDATED_DESCRIPTION_ADDRESS)
        ...
        Address testAddress = addressList.get(addressList.size() - 1);
        assertThat(testAddress.getDescriptionAddress()).isEqualTo(UPDATED_DESCRIPTION_ADDRESS);
        assertThat(testAddress.getReferences()).isEqualTo(UPDATED_REFERENCES);
    ...
    public void searchAddress() throws Exception {
        ...
        restAddressMockMvc.perform(get("/api/_search/addresses?query=id:" + address.getId()))
            ...
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(address.getId().intValue())))
            .andExpect(jsonPath("$.[*].descriptionAddress").value(hasItem(DEFAULT_DESCRIPTION_ADDRESS)))
