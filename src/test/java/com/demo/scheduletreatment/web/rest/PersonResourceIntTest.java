...
public class PersonResourceIntTest {
     ...
     *
     * @see com.demo.scheduletreatment.repository.search.PersonSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createPerson() throws Exception {
        ...
        assertThat(testPerson.getYears()).isEqualTo(DEFAULT_YEARS);
    ...
    public void updatePerson() throws Exception {
        ...
        assertThat(testPerson.getYears()).isEqualTo(UPDATED_YEARS);
