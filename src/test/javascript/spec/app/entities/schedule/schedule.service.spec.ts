...
describe('Service Tests', () => {
    describe('Schedule Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Schedule(0, currentDate, currentDate, currentDate);
        });
        ...
        describe('Service methods', async () => {
            it('should find an element', async () => {
                const returnedFromService = Object.assign(
                    {
                        initialAppointmentDate: currentDate.format(DATE_TIME_FORMAT),
                        finalAppointmentDate: currentDate.format(DATE_TIME_FORMAT),
            ...
            it('should create a Schedule', async () => {
                ...
                const expected = Object.assign(
                    {
                        initialAppointmentDate: currentDate,
                        finalAppointmentDate: currentDate,
